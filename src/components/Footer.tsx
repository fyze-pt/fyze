        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 sm:gap-12 mb-12 sm:mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 sm:space-y-6">
              <li><Link href="/metodo" className="text-zinc-400 hover:text-fyze transition-colors font-bold uppercase tracking-widest text-sm">Método</Link></li>
              <li><Link href="/sobre" className="text-zinc-400 hover:text-fyze transition-colors font-bold uppercase tracking-widest text-sm">Sobre Nós</Link></li>
              <li><Link href="/diagnostico" className="text-zinc-400 hover:text-fyze transition-colors font-bold uppercase tracking-widest text-sm">Analisar o meu negócio</Link></li>
            </ul>
          </div>

          <div>
            <h4 className="font-black uppercase tracking-widest mb-5 sm:mb-8 text-sm text-white">Contacto</h4>
            <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-zinc-400 hover:text-fyze transition-colors font-bold text-sm">
              <Phone size={18} />
              +351 915 709 951
            </a>
          </div>
