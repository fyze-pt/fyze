...
export function MetodoFinalCta({ copy }: { copy: MetodoCopy["finalCta"] }) {
  const onCta = () => {
    trackEvent("cta_click", { location: "metodo_final", label: copy.cta, variant: VARIANT });
  };
    ...
    <section className="py-24 sm:py-32 bg-zinc-950 border-t border-white/5 relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-[900px] mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <motion.h2
          ...
          className="text-3xl sm:text-5xl md:text-6xl font-black tracking-tighter uppercase leading-[0.95] text-white mb-6 text-balance"
        >
          {copy.headline}
        </motion.h2>
        ...
        <motion.p
          ...
          className="text-lg sm:text-xl text-zinc-300 font-medium leading-snug mb-10 max-w-2xl mx-auto text-pretty"
        >
          {copy.subhead}
        </motion.p>
